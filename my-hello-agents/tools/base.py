...
def tool_action(name: str = None, description: str = None):
    ...
    Args:
        ...
        description: 工具描述（如果不描述，从 docstring 提取）
    """
...
class Tool(ABC):
    ...
    def to_openai_schema(self) -> Dict[str, Any]:
        ...
        for param in parameters:
            ...
            # 如果有默认值，添加到描述中（OpenAI chema 不支持 default 字段）
...
class AutoGeneratedTool(Tool):
    ...
    def _parse_parameters(self) -> List[ToolParameter]:
        ...
        # 从 docstring 解析参数描述
        param_description = self._parse_param_descriptions(docstring)
